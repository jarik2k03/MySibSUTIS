...
int main() {
    ...
    FILE *ex1_hash = fopen("graphics/ex6_add.txt", "a+");
    FILE *ex1_hash_col = fopen("graphics/ex6_add_col.txt", "a+");
...
//         if ((x == h & 0xf0000000) != 0) 
//         {
//              h ^= (x >> 24); // Затрагивается 5-8 бит, смешивается один раз 3
//              h &= ~ x; // Очистить четыре старших бита 4
//         }
//         s++;
//     }   
//     return (h & 0x7fffffff);
